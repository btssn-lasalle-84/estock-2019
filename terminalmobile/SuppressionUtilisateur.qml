...
/**
  *
  * @file terminalmobile/SuppressionUtilisateur.qml
  *
  * @brief Définition de la boîte de dialogue SuppressionUtilisateur
  *
...
/**
  ...
  *
  * @brief La boîte de dialogue SuppressionUtilisateur
  *
  * @author Robin Gauthier
  *
  * @version 1.1
...
Dialog {
    id: pageSuppressionUtilisateur
    //title: "Supprimer un Utilisateur" // voir labelTitre
    ...
    Column {
        ...
        Row {
            ...
            Text {
                id: labelTitre;
                text: qsTr("Supprimer un Utilisateur")
        ...
        Row {
            ...
            Text {
                ...
                text: qsTr("Utilisateur à supprimer :")
                elide: Text.ElideMiddle
            ...
            /**
              * @brief Liste déroulante des nom des utilisateurs
              */
            ComboBox {
        ...
        Row {
            ...
            Button {
                ...
                onClicked: {
                    // Annuler
                    pageSuppressionUtilisateur.visible = false
                    reject()
                }
            }
        }
